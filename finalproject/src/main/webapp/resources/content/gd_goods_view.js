                    ...
                    if (i == data.nextKey) {
                        ...
                        for (var j = 0; j < data.nextOption.length; j++) {
                            if (data.optionViewFl[j] == 'y') {
                                ...
                                if ((parseInt(data.nextKey) + 1) == parseInt(optionCnt) && ((stockFl == 'y' && setStockCnt <  setOriginalMinOrderCnt)  || (stockFl == 'y' && setFixedOrderCnt == 'option' && data.stockCnt[j] < setMinOrderCnt) || (stockFl == 'y' && data.stockCnt[j] == 0) || data.optionSellFl[j] == 'n' || data.optionSellFl[j] == 't')) {
                                ...
                                if ((parseInt(data.nextKey) + 1) == parseInt(optionCnt)) {
                                    ...
                                    } else if ((stockFl == 'y' && data.stockCnt[j] == 0) || data.optionSellFl[j] == 'n' || (data.sellStopFl == 'y' && dta.sellStopStock >= data.stockCnt[j])) {
