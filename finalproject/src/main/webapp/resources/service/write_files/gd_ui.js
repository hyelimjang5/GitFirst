            ...
            if(data =='false') {
                ...
                $.each(getData, function (categoryKey, categoryVal) {
                    $.each(categoryVal, function (key, val) {
                        addHtml += '<li style="width:180px;"><div class="all_menu_cont"><a href="../goods/goods_list.php?cateCd='+val.cateCd+'">'+val.cateNm+'</a>';
                        if(val.children) {
                ...
                addHtml += '</ul>';
				addHtml += '</dd>';
				addHtml += '<dd><ul><li style="width:180px;">';
				addHtml += '<div class="all_menu_cont"><a href="../service/index.php">고객센터</a>';
				addHtml += '<ul class="all_depth1">';
				addHtml += '<li><a href="../service/notice.php">공지사항</a></li>';
				addHtml += '<li><a href="../service/qa.php">1:1문의하기</a></li>';
				addHtml += '<li><a href="../service/faq.php">FAQ</a></li>';
				addHtml += '<li><a href="../mypage/mypage_goods_review.php">상품후기</a></li>';
				addHtml += '<li><a href="../board/list.php?bdId=event">이벤트</a></li>';
				addHtml += '</ul>';
				addHtml += '</div></li></ul></dd></dl>';
